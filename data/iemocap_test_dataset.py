...
class IemocapTestDataset(BaseDataset):
    def __init__(self, opt, set_name):
        ...
        label_path = "/data2/ljj/sser_discrete_data/iemocap/target_new/crossVal{}/"
        ...
        print(f"IEMOCAP_TEST dataset {set_name} created with total length: {len(self)}")
        # print(self.acoustic_data.shape)
        # print(self.visual_data.shape)
        # print(self.lexical_data.shape)
